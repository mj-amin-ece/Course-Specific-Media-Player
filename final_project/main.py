"""
            ...
            programmer:mohammad javad and faeze
...
class VideoWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.cb.setStyleSheet(
            style + "background-image : url(.//image//icon//index.png);"
        )
        ...
        # change theme
        default = QAction(
            QtGui.QIcon(".//image//icon//color.jpg"), "&Default color", self
        )
        ...
        self.sld.setStyleSheet(
            "background: red; left: 4px; right: 4px; height: 5px;" + style
        )
        # volume picture
    ...
    def addtag(self):
        ...
        fileName, _ = QFileDialog.getOpenFileName(
            self, "Open Tag", QtCore.QDir.homePath()
        )
        ...
        if fileName != "":
            ...
            self.edit_btn.setEnabled(
                True
            )  # active btn because tag was load and we can edit it
            for i in s:
    ...
    def edit_tag(self):
        ex = EditMessageBox(
            self.value
        )  # Create Object and sent value for fill the table for editing
        a = ex.r()
...
class EditMessageBox(QtWidgets.QMessageBox):
    def __init__(self, items):
        ...
        self.setText("ویرایش")
        self.a = items
        self.addButton(QtWidgets.QPushButton("ذخیره"), QtWidgets.QMessageBox.YesRole)

        self.addButton(QtWidgets.QPushButton("لغو"), QtWidgets.QMessageBox.RejectRole)
